...
- **对手分布才是 curriculum**：未来 progress 必须经 current peers / diverse contemporaries / history / exploiters 的 cross-play 检验，不能把“只克唯一熟悉对手”当进步。
- “学会了语言/战术/角色”是 strong claim：需要 detector/discovery + lineage + 至少一个 mechanism-relevant intervention；相关性/漂亮录像只能标 candidate/hypothesis。
