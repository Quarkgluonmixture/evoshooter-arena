# LOG archive — 2026-09-11 22:15 → 2026-09-13 00:10

归档区间：Programme **A0–A4 · V11/V12 · V6a**（信息层全部关闭）· **换尺子**（cross-play + ladder 分母）
· **inherit**（继承保真度公式）· **yardstick**（0% vs rusher）· **D1 判决** · **C1 全程**（C1a/C1b/C1c，exit 3/3）。

> 定位（live + 全部归档一起搜）：`grep -n '^## ' LOG.md LOG-archive/*.md`
> 更早的条目在 `LOG-2026-09-11-1730-to-2130.md`；之后的在 `../LOG.md`。
